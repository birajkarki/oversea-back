...
app.patch("/service", auth_1.isValidUser, multer_1.default.fields([
...
app.get("/employers", landing_controller_1.landingController.getEmployers);
app.post("/employer", landing_controller_1.landingController.createEmployer);
